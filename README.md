...
To test your code, you can run the provided `lab1.MultiplesTest` in the `test` folder.
The first time you run the tests, you may need to first hover your mouse over one of the
red squiggly lines near the top of `lab1.MultiplesTest.java` and click `more options...`
...
After you have run the tests once, you may see a play button appear beside `lab1.MultiplesTest`
